...
export interface Greeks {
  ...
  rho: number;
  iv: number;
  // Second-order cross-Greeks (populated when computed analytically)
  charm?: number;  // dΔ/dt — delta decay per day
  vanna?: number;  // dΔ/dσ = dVega/dS — vol/spot cross-sensitivity
  volga?: number;  // dVega/dσ (Vomma) — vol convexity
}
